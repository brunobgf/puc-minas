...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        /*ordenação quick sort - START*/
        Quick quickSortObject = new Quick();

        Series[] sortMethodArray = quickSortObject.quicksort(sortSeriesArray, 0, inputCount-1); //recebe o vetor ordenado

        for (int i = 0; i < seriesQtd; i++) {
            sortMethodArray[i].printer(sortMethodArray[i]); //leitura do vetor ordenado
        }
        /*ordenação quick sort - END*/
        ...
        TextFileWrite writeFile = new TextFileWrite("754901_quick.txt");

        writeFile.write("Matricula: 754901 \t" + "Tempo de execução em milisegundos: " + executionTime + "\t Numero de trocas entre elementos: " + quickSortObject.countSwitch + "\t Numero de movimentacoes no vetor: " + quickSortObject.countCompare);
